...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot='tabs-list'
      className={cn(
        "bg-gray-50 dark:bg-accent text-cor-texto inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]",
        className
      )}
      {...props}
    />
