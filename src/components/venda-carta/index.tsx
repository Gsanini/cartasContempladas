  ...
  return (
    <div className='mt-5'>
      ...
      <div className='grid grid-cols-12 gap-4 w-full'>
        ...
        <div className='col-span-12 md:col-span-4 flex flex-col items-start justify-center gap-3 rounded-lg p-4 bg-accent/80 dark:bg-accent/40'>
        ...
        {/* Valor da Venda */}
        <div className='col-span-12 md:col-span-8 flex flex-col gap-1.5 p-3 rounded-lg bg-gradient-to-br from-slate-50 to-slate-100/50 dark:from-slate-900/40 dark:to-slate-800/30 border border-slate-200/50 dark:border-slate-700/50'>
              ...
              {valorPago > 0 && (
                <div className='flex items-center gap-2 px-4 py-1 rounded-lg bg-white/10 backdrop-blur-sm'>
                  ...
                  <p className='text-[10px] font-semibold text-green-400'>
                    {((valorVenda / valorPago) * 100).toFixed(1)}%{" "}
